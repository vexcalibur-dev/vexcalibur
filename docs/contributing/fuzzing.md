...
| `sbom` | Local SBOM loader (CycloneDX JSON/XML, SPDX 2.3 JSON, and SPDX 3 JSON-LD, with format selection) | Format selection, XML defenses, the SPDX 3 context pin, and component-count, depth, reference, version, and package-URL rules remain fail-closed. |
