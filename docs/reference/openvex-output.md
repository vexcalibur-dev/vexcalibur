...
CSAF and SPDX 3 support uses the separate `Csaf20VexJsonRenderer` and
`Spdx3JsonRenderer` over the same atomic document boundary, without changing
source adapters or the default CycloneDX contract.
