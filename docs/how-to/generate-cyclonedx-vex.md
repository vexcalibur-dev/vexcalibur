...
Use `vexcalibur generate` to write CycloneDX 1.6 VEX JSON from a local CycloneDX, [SPDX 2.3](use-spdx2-sbom-input.md), or SPDX 3 SBOM, or a GitHub Dependency Graph SBOM.
...
| Input | Option |
| --- | --- |
| Local CycloneDX JSON or XML, SPDX 2.3 JSON, or SPDX 3 JSON-LD | Positional `INPUT_FILE` |
