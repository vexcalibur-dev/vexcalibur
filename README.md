...
Vexcalibur reads CycloneDX JSON/XML, SPDX 2.3 JSON, and SPDX 3 JSON-LD SBOM files, or fetches an SBOM from GitHub. It generates CycloneDX, OpenVEX, CSAF, and SPDX 3 VEX documents. The [generation guides](https://vexcalibur-dev.github.io/vexcalibur/#how-to-guides) explain the inputs and metadata each format needs.
